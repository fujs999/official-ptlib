...
PChannelStreamBuffer::pos_type PChannelStreamBuffer::seekoff(std::streamoff off, ios::seekdir dir, ios::openmode)
{
  sync();
...
PChannelStreamBuffer::pos_type PChannelStreamBuffer::seekpos(pos_type pos, ios::openmode mode)
{
...
bool PNullChannel::Read(void *, PINDEX)
{
  SetLastReadCount(0);
  return false;
}
...
bool PNullChannel::Write(const void *, PINDEX length)
{
...
bool PFile::Close()
{
  ...
  bool ok = true;
#else
  bool ok = ConvertOSError(_close(GetOSHandleAsInt()));
#endif
